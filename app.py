...
def imageInput(device):
    ...
    if image_file is not None:
        ...
        with open(imgpath, mode="wb") as f:
            ...
            st.caption("Saliency mask view of the leaf")
            st.image(salie_im, width=528, channels="RGB")

        # call Model prediction--
        
        model = torch.hub.load('ultralytics/yolov5', 'custom', path='models/yleafinev5.pt', force_reload=True, _verbose=False, source='local')
